...
async function postVerifyPanel() {
  ...
  const embed = new EmbedBuilder()
    ...
    .setDescription(
      ...
      '🔐 This helps us keep the server safe and connect you to your club account.\n\n' +
    ...
    if (customId === 'verify_modal') {
      ...
      const onboardEmbed = new EmbedBuilder()
        ...
        .addFields(
          ...
          { name: 'How They Found Us', value: howFound, inline: true }
        )
        .setColor(0x2ECC71)
        .setFooter({ text: `Staff: use !verify @${user.username} to approve.` });
